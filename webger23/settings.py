...
ALLOWED_HOSTS = ['http://18.221.29.129'] # Aqui eu coloco o código gerado pelo ngrok para acesso externo sem o "https"

# Configuração de origens confiáveis, para funcionamento do CSRF_TOKEN
CSRF_TRUSTED_ORIGINS = [] # Aqui eu coloco o código gerado pelo ngrok para acesso externo
